...
def get_daily():
    os.chdir('/Users/u1560915/Documents/OneDrive/PhD_Plastic_Oceans/Experiments/Chitinase/Results_Chitin/Chitin_A_results/daily/')
    g15 = ['RW_C20_d1_plate-2.csv', 'RW_C20_d1_plate-3.csv', 'RW_C20_d2_plate-2.csv', 'RW_C20_d2_plate-3.csv', 'RW_C20_d4_plate-2.csv', 'RW_C20_d4_plate-3.csv', 'RW_C20_d6_plate-2.csv', 'RW_C20_d6_plate-3.csv', 'RW_C20_d9_plate-2.csv', 'RW_C20_d9_plate-3.csv']
    ...
    g15_s, g20_s = [], []
    for a in range(len(g15)):
        standards, community = get_this_file_txt(g15[a])
        g15[a] = community
    ...
    g15_r, g15_g = [g15[0], g15[2], g15[4], g15[6], g15[8]], [g15[1], g15[3], g15[5], g15[7], g15[9]]
    g20_r, g20_g = [g20[0], g20[2], g20[4], g20[6]], [g20[1], g20[3], g20[5], g20[7]]
    g15_s2, g15_e, g20_s2, g20_e = [], [], [], []
    for b in [0, 2, 4, 6, 8]:
        c = b+1
        standards = [g15_s[b], g15_s[c]]
...
def get_paper_plot(LS, g):
    ...
    ax3 = plt.subplot2grid((3, 10), (0, 7), colspan=3, rowspan=2)
    ...
    ax1.legend(bbox_to_anchor=(0.55,1), fontsize=8, frameon=False, numpoints=1, handlelength=0)
    ax1.plot([0, 20], [0, 0], 'k--')
    ax3.plot([0, 5], [0, 0], 'k--')
    ax1.set_xlim([-1, 21])
    ...
    plt.subplots_adjust(left=0.125, bottom=0.1, right=0.9, top=0.9,wspace=2.5, hspace=1)
