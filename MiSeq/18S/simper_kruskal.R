...
OTU2 <- read.table(file = "/Users/u1560915/Documents/OneDrive/PhD_PlasticOceans/Experiments/MiSeq/18S_analysis/12_LS_percent_r.csv", header = TRUE, sep = ",")
#0_percent_r.csv, 2_RGL_percent_r.csv, 3_daily_percent_r.csv, 4_LG_percent_r.csv, 5_RG_percent_r.csv, 7_beginning_percent_r.csv, 8_beg_end_percent_r.csv, 9_L_GR_percent_r.csv, 10_S_GR_percent_r.csv, 11_beg_end_S_percent_r.csv, 12_LS_percent_r.csv

tax2 <- read.table(file = "/Users/u1560915/Documents/OneDrive/PhD_PlasticOceans/Experiments/MiSeq/18S_analysis/stability.final.pick.taxonomy", header = TRUE, sep = "\t")

meta2 <- read.table(file = "/Users/u1560915/Documents/OneDrive/PhD_PlasticOceans/Experiments/MiSeq/18S_analysis/12_LS_meta.csv", header = TRUE, row.names = 1, sep = ",")
#0_meta.csv,  2_RGL_meta.csv, 3_daily_meta.csv, 4_LG_meta.csv, 5_RG_meta.csv, 7_beginning_meta.csv, 8_beg_end_meta.csv, 9_L_GR_meta.csv, 10_S_GR_meta.csv, 11_beg_end_S_meta.csv, 12_LS_meta.csv
