...
plt1OTU, plt1tax = ['OTU3 \n', 'OTU4 \n', 'OTU1 \n', 'OTU2 \n', 'OTU14 \n'], ['Cellvibrionaceae', r'$Thalassotalea$', r'$Donghicola$', 'Bacteria', r'$Carboxylicivirga$']
plt2OTU, plt2tax = ['OTU1 \n', 'OTU3 \n', 'OTU2 \n', 'OTU5 \n', 'OTU4 \n'], [r'$Donghicola$', 'Cellvibrionaceae', 'Bacteria', r'$Crocinitomix$', r'$Thalassotalea$']
...
def plot_simper(sf, axis, colors, labels, plc, text, ylim, ot, ta):
    ...
    for e in range(5):
        ...
        axis[e].text(1.5, text, '${'+r'p = '+'}$'+'%.3f'%float(p_vals[e]), va='bottom', ha='left', color='#bd0303', fontsize=8)
        #axis[e].set_xticklabels(nums)
        axis[e].set_title(ot[e]+ta[e], fontsize=10)
...
plot_simper('11_beg_end_S_percent_simper_mean.csv', axis1, colors1, labels1, plc=2, text=33, ylim=38, ot=plt1OTU, ta=plt1tax)
plot_simper('12_LS_percent_simper_mean.csv', axis2, colors2, labels2, plc=2, text=33, ylim=38, ot=plt2OTU, ta=plt2tax)
