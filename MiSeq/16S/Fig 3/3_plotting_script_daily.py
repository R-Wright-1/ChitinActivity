...
def stacked_barchart(fn, level=6):
    ...
    OTUs = ['OTU1','OTU2','OTU3','OTU4','OTU5','OTU7','OTU9','OTU10','OTU12','OTU13','OTU14','OTU18','OTU20','OTU30','OTU33','OTU35','OTU38','OTU52','OTU53', '']
    nline = '\n'
    tax = [r'$Donghicola$', 'Bacteria', 'Cellvibrionaceae', r'$Thalassotalea$', r'$Crocinitomix$', r'$Terasakiella$', 'Clostridiales', r'$Marinobacter$', 'Lachnospiraceae', r'$Muricauda$', r'$Carboxylicivirga$', 'Rhodobacteraceae', r'$Desulfovibrio$', r'$Thalossolituus$', 'Colwelliaceae', r'$Catenococcus$', r'$Aestuariicella$', r'$Chitinivibrio$', r'$Marinimicrobium$', 'Other']
    ...
    ax7.legend(loc='upper left', bbox_to_anchor=(1.02, 1.015), ncol=2, fontsize=10)
...
def plot_simper(sf):
    ...
    nums3 = [1, 2, 3, 4]
    nums = ['1', '2', '3', '4']
    OTUs = ['OTU4', 'OTU3', 'OTU5', 'OTU7', 'OTU14']
    tax = [r'$Thalassotalea$', 'Cellvibrionaceae', r'$Crocinitomix$', r'$Terasakiella$', r'$Carboxylicivirga$']
    nline = '\n'
    ax3.set_xlabel('Day')
    for e in range(5):
        ...
        axis[e].text(2.75, 33, '${'+r'p = '+'}$'+'%.3f'%float(p_vals[e]), va='bottom', ha='left', color='#bd0303', fontsize=8)
