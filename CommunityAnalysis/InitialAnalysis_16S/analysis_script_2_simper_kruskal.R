...
OTU2 <- read.table(file = "/Users/u1560915/Documents/GitHub/CommunityAnalysis/InitialAnalysis/treatment1_daily_samples_for_simper_r.csv", header = TRUE, sep = ",")
# treatment2_all_rg_ls_samples_for_simper_r.csv

meta2 <- read.table(file = "/Users/u1560915/Documents/GitHub/CommunityAnalysis/InitialAnalysis/treatment1_daily_meta.csv", header = TRUE, row.names = 1, sep = ",")
...
source("/Users/u1560915/Documents/GitHub/CommunityAnalysis/InitialAnalysis/simper_pretty.r")
