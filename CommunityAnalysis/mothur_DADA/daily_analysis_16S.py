...
fn_16S_DADA = '16S_all_DADA_bar.csv' 
sim_16S_DADA = '16S_simper_DADA.csv'
tax_16S_DADA = '16S_taxonomy_DADA.csv'
...
simper(sim_16S_DADA, tax_16S_DADA, 5, s16S, [1, 2, 3, 4], [0.5, 4.5], [0, 40], cols_16S, 0.6, 35, '16S')

barplot(fn_16S_DADA, tax_16S_DADA, 1, l16S, 0.8)
...
s1_16S.text(-1.4, 20, 'DADA2 analysis', fontsize=10, ha='center', va='center', rotation=90)

fn_16S = '16S_daily_percent_grouped.csv'
sim_16S = '16S_daily_simper.csv'
ord_16S = '16S_3_order.csv'
tax_16S = '16S_taxonomy_mothur.csv'
meta_16S = '16S_daily_meta.csv'
...
krusk, krusk_p, treat_mean, treat_sd, cont, print_otus, tax = simper_mothur(sim_16S, ord_16S, meta_16S, tax_16S, 8)
simper_plot_mothur(krusk, krusk_p, treat_mean, treat_sd, cont, print_otus, tax, s18S, [1, 2, 3, 4], [0.75, 5], [0, 40], cols_16S, 0.6, 35, '')

barplot_mothur(fn_16S, tax_16S, 1, l18S, 0.8)



s1_18S.text(-1.4, 20, 'Mothur analysis', fontsize=10, ha='center', va='center', rotation=90)
plt.setp(l18S.get_yticklabels(), visible=False)
fig.subplots_adjust(hspace=200, wspace=0.4)
plt.savefig('16S daily comparison.png', bbox_inches='tight', dpi=600)
