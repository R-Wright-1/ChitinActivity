...
"""
ax1 = plt.subplot2grid((3, 20), (0, 0), colspan=10)
ax2 = plt.subplot2grid((3, 20), (1, 7), colspan=3)
ax3 = plt.subplot2grid((3, 20), (2, 7), colspan=3)
"""
ax1 = plt.subplot2grid((6, 10), (0, 0), colspan=10)
ax2 = plt.subplot2grid((6, 10), (1, 7), colspan=3)
ax3 = plt.subplot2grid((6, 10), (2, 7), colspan=3)
...
ax1.set_xlim([-0.2, 21])
ax1.legend(bbox_to_anchor=(1.35, 1.05), fontsize=8)
...
ax1.set_title('Chitinase (K01183)')
...
"""
ax1 = plt.subplot2grid((3, 20), (0, 10), colspan=10)
ax2 = plt.subplot2grid((3, 20), (1, 17), colspan=3)
ax3 = plt.subplot2grid((3, 20), (2, 17), colspan=3)
"""
ax1 = plt.subplot2grid((6, 10), (3, 0), colspan=10)
ax2 = plt.subplot2grid((6, 10), (4, 7), colspan=3)
ax3 = plt.subplot2grid((6, 10), (5, 7), colspan=3)
...
ax3.set_xlabel('Day')
ax6.set_ylabel(r'Chitinase $\mu$M day$^{-1}$'+'\nDaily')
ax1.set_title('D', loc='left', weight='bold')
ax2.set_title('E', loc='left', weight='bold')
ax3.set_title('F', loc='left', weight='bold')
ax1.set_title('Chitin deacetylase (K01452)')

plt.tight_layout()

plt.savefig('Positive combined.png', bbox_inches='tight', dpi=600)
plt.close()
