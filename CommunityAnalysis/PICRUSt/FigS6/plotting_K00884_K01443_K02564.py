...
fn = 'New_file_GlcNAc_GlcNAc6P_GlcN6P_Fru6P.csv'
...
ax1.bar(gens_nums[0], data[2], color=colors[2], width=1.0, label=labels[2], edgecolor='k')
#print(data[0], labels[0])
for j in range(1, data.shape[0]):
    #print(data[j], labels[j])
    if j == 5 or j == 6 or j == 10 or j == 13 or j == 20 or j == 23 or j == 24:
...
ax1.set_title('N-acetyl-glucosamine kinase, N-acetyl-glucosamine-6-phosphate deacetylase, \nHexokinase, Glucosamine kinase and Glucosamine-6-phosphate deaminase'+'\nK00884, K01443, K00884, K18676 and K02564')
