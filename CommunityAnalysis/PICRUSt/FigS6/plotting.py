...
colors = [(0.9882318561731354, 0.09498736674843222, 0.9525020765961463), (0.165592134311359, 0.6875060356683805, 0.9810826051817051), (0.22631448504420415, 0.9657664196501999, 0.5220952588866027), (0.6188605924760333, 0.1535598241735433, 0.9844540532851332), (0.19266493645622562, 0.9710919719278501, 0.31721326213168555), (0.1346797148185467, 0.9527559864233326, 0.06354264772247853), (0.20273415377606174, 0.5099806984843787, 0.9708505155468544), (0.9612516839804537, 0.050730981744208314, 0.050730981744208314), (0.34069706147509826, 0.03287143908451917, 0.9948265090550806), (0.9981724540890615, 0.5837828990778526, 0.20126946368289067), (0.05453246259507405, 0.9512393463233872, 0.6284248681811946), (0.9948571361629778, 0.7595462636665931, 0.1544611629616034), (0.622936018376116, 0.9619169635404718, 0.1915057245305729), (0.9700329986922454, 0.14170573018400323, 0.7381013635099376), (0.7966698599156808, 0.9922278688931991, 0.014437824005608668), (0.9684463894694626, 0.3276352985546166, 0.1252739014236126), (0.21063062618402761, 0.14392807897052284, 0.977709919139327), (0.9834988537732988, 0.1798899065536158, 0.37275605388633937), (0.1444335374361364, 0.8799168019170712, 0.9802099743462899), (0.12363618801967113, 0.26083766083550064, 0.981145393118607), (0.9982622429198621, 0.09304534114160379, 0.5275494539951675), (0.7898004626320396, 0.07743531671145276, 0.9678917491121866), (0.21667352268013618, 0.9700700135081748, 0.8796624346088104), (0.9789094729933332, 0.9435270710625876, 0.09434942472469188), (0.35782910204705665, 0.9816511402402655, 0.06426578995613474)]

for a in range(len(labels)):
    labels[a] = labels[a]+' ('+ASVs[a]+')'
data = numpy.array(means[0])
bottom = numpy.cumsum(data, axis=0)
ax1.bar(gens_nums[2], data[2], color=colors[2], width=1.0, label=labels[2], edgecolor='k')
...
plt.setp(ax1, yticks=[0, 0.1, 0.2, 0.3, 0.4])
...
bottom = numpy.cumsum(data, axis=0)
ax2.bar(gens_n, data[2], color=colors[2], width=1.0, edgecolor='k', label=labels[2])
for j in range(1, data.shape[0]):
    if j == 13:
...
plt.setp(ax2, yticks=[0, 0.025, 0.05, 0.075, 0.1])
ax2.set_ylim([0, 0.1])
...
ax1.set_title('Chitin deacetylase\nK01452')
